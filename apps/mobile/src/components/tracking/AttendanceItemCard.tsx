...
Tujuan           : Menampilkan kartu catatan riwayat presensi satu pertemuan dengan status, tanggal, swipe-to-delete, dan aksi hapus
Layout strategy  : Swipeable row dengan indicator bar warna status di sisi kiri, informasi tanggal dan catatan di tengah, delete button di kanan
...
export const AttendanceItemCard: React.FC<AttendanceItemCardProps> = ({ item, onDelete }) => {
  ...
  return (
    <UniSwipeable onDelete={onDelete ? () => onDelete(item.id) : undefined}>
      <Animated.View
